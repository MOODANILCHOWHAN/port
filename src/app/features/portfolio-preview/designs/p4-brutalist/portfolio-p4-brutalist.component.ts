...
@Component({
  selector: 'app-portfolio-p4-brutalist',
  templateUrl: './portfolio-p4-brutalist.component.html',
  styleUrls: ['./portfolio-p4-brutalist.component.scss'],
})
export class PortfolioP4Component implements OnInit {
