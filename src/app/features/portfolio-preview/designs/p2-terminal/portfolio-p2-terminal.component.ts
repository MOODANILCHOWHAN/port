...
@Component({
  selector: 'app-portfolio-p2-terminal',
  templateUrl: './portfolio-p2-terminal.component.html',
  styleUrls: ['./portfolio-p2-terminal.component.scss'],
})
export class PortfolioP2Component implements OnInit {
